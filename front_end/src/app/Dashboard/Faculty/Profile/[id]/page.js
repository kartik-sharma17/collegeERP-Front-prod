...
import { API_URL } from '@/app/Dashboard/Constant/envVariable';
import { ApiEndPoint } from '@/app/Dashboard/Constant/apiEndpoints';
...
export const StudentProfile = () => {
  ...
  const fetchData = async () => {
    try {
      await axios.get(`${API_URL}${ApiEndPoint.Faculty.Profile}${id}`).then((res) => {
        setResData(res.data);
        console.log(res); 
        setLoading(true);
      })
