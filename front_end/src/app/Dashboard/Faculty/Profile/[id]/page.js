        ...
        <div className={`${"row w-100 text-light"}`}>
          <div className={` ${"col-12 col-md-7 pe-2 ps-0"}`}>
            <div style={{ minHeight: "100%" }} className={`${"custom_bg_color"} ${"p-3 rounded-4"}`}>
              ...
              <h6><span className={"label"}>Name :</span> {resData.name}</h6>
              <h6><span className={"label"}>Faculty ID : </span> {resData.id}</h6>
              <h6><span className={"label"}>Number : </span> {resData.number}</h6>
              <h6><span className={"label"}>Alloted Subject : </span> {resData.allotedSubject}</h6>
              <h6><span className={"label"}>Section Mentor : </span> {resData.section}</h6>
              <h6><span className={"label"}>Email : </span> {resData.email}</h6>
              <h6><span className={"label"}>Department : </span> {resData.department}</h6>
              <h6><span className={"label"}>Position : </span> {resData.position}</h6>
            </div>
          </div>
        </div>
      </div>
