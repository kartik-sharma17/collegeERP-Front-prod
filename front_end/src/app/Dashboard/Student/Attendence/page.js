  ...
  return (
    ...
    <div className={`${styles.main} ${'w-100 d-flex justify-content-center mt-2'}`}>
      <div className={`${styles.side_bar} ${'px-3 py-4 d-flex flex-column'}`}>
        ...
        <buttom onClick={() => { route.push("Attendence") }} className={`${styles.custom_btn} ${'active w-100 rounded-3 py-2 px-3 mt-2 d-flex justify-content-between align-items-center'}`}><span><FontAwesomeIcon className='me-1' icon={faCalendarWeek} /> Attendence</span> <FontAwesomeIcon className='text-dark' icon={faChevronRight} /></buttom>
