...
const page = () => {
  ...
  var totalMarks = parseInt(data.get("s1s1Marks")) + parseInt(data.get("s1s2Marks")) + parseInt(data.get("s1s3Marks")) + parseInt(data.get("s1s4Marks")) + parseInt(data.get("s1s5Marks")) + parseInt(data.get("s1s6Marks"));
    ...
    <div className='row'>
      <div className="col-12 col-md-6 px-2">
        <div className='custom_bg_color p-3 rounded-3'>
          <h4 className='text-light pb-1' style={{ borderBottom: "1px solid #5B5D5C" }}>Sessional 1 Result</h4>
          <div className="row">
            <div className="col-6">
              <h6 className='text-light'><span className={"label"}>{data.get('s1s1')} : </span> {data.get('s1s1Marks')}</h6>
              <h6 className='text-light'><span className={"label"}>{data.get('s1s2')} : </span> {data.get('s1s2Marks')}</h6>
              <h6 className='text-light'><span className={"label"}>{data.get('s1s3')} : </span> {data.get('s1s3Marks')}</h6>
            </div>
            <div className="col-6">
              <h6 className='text-light'><span className={"label"}>{data.get('s1s4')} : </span> {data.get('s1s4Marks')}</h6>
              <h6 className='text-light'><span className={"label"}>{data.get('s1s5')} : </span> {data.get('s1s5Marks')}</h6>
