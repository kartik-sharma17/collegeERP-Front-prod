  ...
  if (loading) return (
    <>
      <div className="row">
        ...
        <div className="col-12 col-md-6 px-2">
          <Link  className='text-decoration-none' href={`/Dashboard/Student/Result/${id}/sessional2`}>
            <div className='custom_bg_color p-3 rounded-4'>
        ...
        <div className="col-12 col-md-6 px-2 py-2">
          <Link  className='text-decoration-none' href={`/Dashboard/Student/Result/${id}/sessional3`}>
            <div className='custom_bg_color p-3 rounded-4'>
        ...
        <div className="col-12 col-md-6 px-2 py-2">
          <Link  className='text-decoration-none' href={`/Dashboard/Student/Result/${id}/put`}>
            <div className='custom_bg_color p-3 rounded-4'>
